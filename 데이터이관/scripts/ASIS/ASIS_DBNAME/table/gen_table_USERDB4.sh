...
sed '/CREATING Table - "FUND_BK.dbo.pbcatcol"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.dbo.pbcatedt"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.dbo.pbcatfmt"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.dbo.pbcattbl"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.dbo.pbcatvld"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.dbo.tb_la19dt"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.fund.tb_co06dt_040629_2"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.fund.tb_co06ld_040629"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql
...
sed '/CREATING Table - "FUND_BK.fund.tb_co06ld_040714"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.fund.tb_co08ld_040629"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.fund.tb_in01ld_040826"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.fund.temp_131011_1"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql

sed '/CREATING Table - "FUND_BK.fund.yellow_regid"/,/-----/s/^/--/g' < ${WORK_PATH}/$1/$1_table.sql> ${WORK_PATH}/$1/$1_table_1.sql
rm ${WORK_PATH}/$1/$1_table.sql
mv ${WORK_PATH}/$1/$1_table_1.sql $1_table.sql
