...
sed 's/\.dbo\./\.fund\./g' < ${WORK_PATH}/$1/create_index_$DB_name.sh > ${WORK_PATH}/$1/create_index_$DB_name1.sh
rm ${WORK_PATH}/$1/create_index_$DB_name.sh
mv ${WORK_PATH}/$1/create_index_$DB_name1.sh create_index_$DB_name.sh
...
sed 's/FUND_DB\.\./FUND_DB\.fund\./g' < ${WORK_PATH}/$1/create_index_$DB_name.sh > ${WORK_PATH}/$1/create_index_$DB_name1.sh
rm ${WORK_PATH}/$1/create_index_$DB_name.sh
mv ${WORK_PATH}/$1/create_index_$DB_name1.sh create_index_$DB_name.sh

sed -e "5 i\setuser 'fund' " < ${WORK_PATH}/$1/create_index_$DB_name.sh > ${WORK_PATH}/$1/create_index_$DB_name1.sh
rm ${WORK_PATH}/$1/create_index_$DB_name.sh
mv ${WORK_PATH}/$1/create_index_$DB_name1.sh create_index_$DB_name.sh

sed -e "6 i\go" < ${WORK_PATH}/$1/create_index_$DB_name.sh > ${WORK_PATH}/$1/create_index_$DB_name1.sh
rm ${WORK_PATH}/$1/create_index_$DB_name.sh
mv ${WORK_PATH}/$1/create_index_$DB_name1.sh create_index_$DB_name.sh

sed 's/fund.tb_cp_mon_sum (totym,evlym,lendnum)/fund.tb_cp_mon_sum (totym,evlym,lendnum,entrnum)/g' < ${WORK_PATH}/$1/create_index_$DB_name.sh > ${WORK_PATH}/$1/create_index_$DB_name1.sh
rm ${WORK_PATH}/$1/create_index_$DB_name.sh
mv ${WORK_PATH}/$1/create_index_$DB_name1.sh create_index_$DB_name.sh

sed 's/fund.tb_in08ld (work_num,entr_num)/fund.tb_in08ld (work_num,entr_num,rnd)/g' < ${WORK_PATH}/$1/create_index_$DB_name.sh > ${WORK_PATH}/$1/create_index_$DB_name1.sh
rm ${WORK_PATH}/$1/create_index_$DB_name.sh
mv ${WORK_PATH}/$1/create_index_$DB_name1.sh create_index_$DB_name.sh
